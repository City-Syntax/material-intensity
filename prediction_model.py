...
def prepare_data(
    ...
    preprocessor = ColumnTransformer(transformers=[
        ...
        ("cat", OneHotEncoder(handle_unknown="ignore", sparse_output=False),
         ["Construction period bucket", "Typology", "Primary Code", "Country", "Geo_macro"]),
    ])
...
# The low-support sub-group (archetype_n_train <= 3) is analysed
# separately because IPW up-weights under-represented archetypes and
# should benefit them most.
# ==========================================================
